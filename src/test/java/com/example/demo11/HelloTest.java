...
public class HelloTest {
	...
	public void staticFinalTest() {
		...
		// 而因為 PI 本身有 static 所以不需要先創建才能使用，而是大家都存取同一個記憶體空間裡的值
		// 創建是指建立一個記憶體空間給該物件
	...
	public void variableTest() {
		...
		//字元
		char i = 'c';
		char l = 65; //當把數字放入 char 的容器中時，程式會自動解讀為文字編碼，找到該數字相對應的字元
		...
		// 當沒有小數點時<程式會自動將數字理解為 int(整數)，因此計算的結果也會用整數的方式呈現
		System.out.println(5/2);
		System.out.println(5/2.0);
		System.out.println(5.0/2);
		// 而只要有任何一數是小數，程式就能以小數的方式去計算出結果(2.5)
		double res2 = (double)(5/2);
		// 程式執行的順序會是整數5和整數2相除，再將相除出來的整數轉換為小數，最後塞入小數的容器中，因此結果會是 2.0 而不是 2.5 
